...
namespace tainicom.Aether.Physics2D.Diagnostics
{
	...
	public class DebugView : DebugViewBase, IDisposable
	{
		...
		private void DrawPerformanceGraph()
		{
			...
			DrawString(PerformancePanelBounds.Right + 10, PerformancePanelBounds.Top, _graphSbMax.Append("Max: ").Append(_max.TotalMilliseconds).Append(" ms"));
			DrawString(PerformancePanelBounds.Right + 10, PerformancePanelBounds.Center.Y - 7, _graphSbAvg.Append("Avg: ").Append(_avg.TotalMilliseconds).Append(" ms"));
			DrawString(PerformancePanelBounds.Right + 10, PerformancePanelBounds.Bottom - 15, _graphSbMin.Append("Min: ").Append(_min.TotalMilliseconds).Append(" ms"));
		...
		private void DrawDebugPanel()
		{
			...
			_debugPanelSbObjects.Append("- Bodies:   ").Append(World.BodyList.Count).AppendLine();
			_debugPanelSbObjects.Append("- Fixtures: ").Append(fixtureCount).AppendLine();
			_debugPanelSbObjects.Append("- Contacts: ").Append(World.ContactCount).AppendLine();
			_debugPanelSbObjects.Append("- Proxies:  ").Append(World.ProxyCount).AppendLine();
			_debugPanelSbObjects.Append("- Joints:   ").Append(World.JointList.Count).AppendLine();
			_debugPanelSbObjects.Append("- Controllers: ").Append(World.ControllerList.Count).AppendLine();
			DrawString(x, y, _debugPanelSbObjects);

			_debugPanelSbUpdate.Clear();
			_debugPanelSbUpdate.Append("Update time:").AppendLine();
			_debugPanelSbUpdate.Append("- Body:    ").Append(World.SolveUpdateTime.TotalMilliseconds).Append(" ms").AppendLine();
			_debugPanelSbUpdate.Append("- Contact: ").Append(World.ContactsUpdateTime.TotalMilliseconds).Append(" ms").AppendLine();
			_debugPanelSbUpdate.Append("- CCD:     ").Append(World.ContinuousPhysicsTime.TotalMilliseconds).Append(" ms").AppendLine();
			_debugPanelSbUpdate.Append("- Joint:   ").Append(World.Island.JointUpdateTime.TotalMilliseconds).Append(" ms").AppendLine();
			_debugPanelSbUpdate.Append("- Controller:").Append(World.ControllersUpdateTime.TotalMilliseconds).Append(" ms").AppendLine();
			_debugPanelSbUpdate.Append("- Total:   ").Append(World.UpdateTime.TotalMilliseconds).Append(" ms").AppendLine();
